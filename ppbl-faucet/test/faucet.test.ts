...
const address = wallet.getChangeAddress();
    ...
    it('Lock faucet tokens', async() => {
        ...
        const tx = new MeshTx(wallet, provider, networkId);
        const result = await tx.lock(withdrawalAmount, faucetLockedAmount, faucetTokenHex, faucetTokenPolicy, accessTokenPolicy);
    ...
    it('Withdrawal Faucet Token', async() => {
        ...
        const tx = new MeshTx(wallet, provider, networkId);
        const result = await tx.withdrawal(withdrawalAmount, faucetTokenHex, faucetTokenPolicy, accessTokenHex, accessTokenPolicy);
